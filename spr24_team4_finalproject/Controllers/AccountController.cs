...
// these using statements to match your project
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel rvm)
        {
            ...
            AppUser newUser = new AppUser
            {
                ...
                State = rvm.State,
                Zip = rvm.Zip,
                AdvNumber = GenerateAdvantageNumber()
            };
        ...
        public IActionResult Index()
        {
            ...
            ivm.FullName = $"{user.FirstName} {user.MiddleInitial} {user.LastName}"; // Combine first name and last name to get full name
            ivm.DateOfBirth = user.DateOfBirth;
            ivm.Address = user.Address;
            ivm.PhoneNumber = user.PhoneNumber;
            ivm.AdvNumber = user.AdvNumber;
